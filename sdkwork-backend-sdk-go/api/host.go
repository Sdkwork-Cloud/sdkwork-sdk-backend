...
func NewHostApi(client *sdkhttp.Client) *HostApi {
    return &HostApi{client: client}
}

// 更新域名
func (a *HostApi) Update(body sdktypes.PlusHostDomainForm) (sdktypes.PlusApiResultPlusHostDomainVO, error) {
...
// 创建域名
func (a *HostApi) Create(body sdktypes.PlusHostDomainForm) (sdktypes.PlusApiResultPlusHostDomainVO, error) {
...
// 分页获取域名
func (a *HostApi) ListByPage(body *sdktypes.QueryListForm, query map[string]interface{}) (sdktypes.PlusApiResultPagePlusHostDomainVO, error) {
...
// 获取所有域名
func (a *HostApi) ListAllEntities(body *sdktypes.QueryListForm) (sdktypes.PlusApiResultListPlusHostDomainVO, error) {
...
// 获取域名详情
func (a *HostApi) GetById(id string) (sdktypes.PlusApiResultPlusHostDomainVO, error) {
...
// 删除域名
func (a *HostApi) Delete(id string) (sdktypes.PlusApiResultBoolean, error) {
