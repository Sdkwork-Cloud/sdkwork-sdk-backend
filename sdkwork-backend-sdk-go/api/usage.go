...
func NewUsageApi(client *sdkhttp.Client) *UsageApi {
    return &UsageApi{client: client}
}

// Update an existing usage record
func (a *UsageApi) Update(body sdktypes.UsageRecordForm) (sdktypes.PlusApiResultUsageRecordVO, error) {
...
func (a *UsageApi) Create(body sdktypes.UsageRecordForm) (sdktypes.PlusApiResultUsageRecordVO, error) {
...
func (a *UsageApi) ListByPage(body *sdktypes.QueryListForm, query map[string]interface{}) (sdktypes.PlusApiResultPageUsageRecordVO, error) {
...
func (a *UsageApi) ListAllEntities(body *sdktypes.QueryListForm) (sdktypes.PlusApiResultListUsageRecordVO, error) {
...
func (a *UsageApi) GetById(id string) (sdktypes.PlusApiResultUsageRecordVO, error) {
...
func (a *UsageApi) Delete(id string) (sdktypes.PlusApiResultBoolean, error) {
