...
type AiToolApi struct {
    client *sdkhttp.Client
}

func NewAiToolApi(client *sdkhttp.Client) *AiToolApi {
    return &AiToolApi{client: client}
}

// Update an existing AI tool
func (a *AiToolApi) Update(body sdktypes.PlusAiToolForm) (sdktypes.PlusApiResultPlusAiToolVO, error) {
...
func (a *AiToolApi) Create(body sdktypes.PlusAiToolForm) (sdktypes.PlusApiResultPlusAiToolVO, error) {
...
func (a *AiToolApi) ListByPage(body *sdktypes.QueryListForm, query map[string]interface{}) (sdktypes.PlusApiResultPagePlusAiToolVO, error) {
...
// Get all AI tools
func (a *AiToolApi) ListAllEntities(body *sdktypes.QueryListForm) (sdktypes.PlusApiResultListPlusAiToolVO, error) {
...
func (a *AiToolApi) GetById(id string) (sdktypes.PlusApiResultPlusAiToolVO, error) {
...
// Delete an AI tool
func (a *AiToolApi) Delete(id string) (sdktypes.PlusApiResultBoolean, error) {
