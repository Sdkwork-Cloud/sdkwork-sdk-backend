...
func (a *FeedApi) Update(body sdktypes.PlusFeedsForm) (sdktypes.PlusApiResultPlusFeedsVO, error) {
...
func (a *FeedApi) Create(body sdktypes.PlusFeedsForm) (sdktypes.PlusApiResultPlusFeedsVO, error) {
...
func (a *FeedApi) ListByPage(body *sdktypes.QueryListForm, query map[string]interface{}) (sdktypes.PlusApiResultPagePlusFeedsVO, error) {
...
func (a *FeedApi) ListAllEntities(body *sdktypes.QueryListForm) (sdktypes.PlusApiResultListPlusFeedsVO, error) {
...
func (a *FeedApi) GetById(id string) (sdktypes.PlusApiResultPlusFeedsVO, error) {
