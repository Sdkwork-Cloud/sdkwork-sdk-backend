...
export interface PlusAiAgentVO {
  ...
  /** Prompt ID (foreign key to plus_ai_prompt.id) */
  promptId?: number;
  /** Category ID (foreign key to plus_ai_agent_category.id) */
  categoryId?: number;
  /** Chat options (temperature, top_p, etc.) */
  chatOptions?: PlusChatOptions;
  /** Agent configuration (welcome message, suggested questions, etc.) */
  config?: PlusAiAgentConfig;
  /** Usage count */
  usageCount?: number;
}
