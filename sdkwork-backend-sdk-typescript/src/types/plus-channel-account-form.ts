...
export interface PlusChannelAccountForm {
  /** Channel account name (displayed in management interface) */
  name: string;
  ...
  /** Model configuration parameters (JSON structure with model type, API key, etc.) */
  ...
  /** Channel account description (usage scenarios, precautions, etc.) */
  description?: string;
}
