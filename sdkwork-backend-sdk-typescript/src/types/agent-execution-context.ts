...
import type { ChatMessageListener } from './chat-message-listener';
import type { ChatResponseHandler } from './chat-response-handler';
import type { Flow } from './flow';
import type { PlusAgent } from './plus-agent';
import type { PlusDiskObject } from './plus-disk-object';
import type { PlusFileObject } from './plus-file-object';
import type { PlusProjectObject } from './plus-project-object';
...
export interface AgentExecutionContext {
  ...
  createAt?: string;
  maxDuration?: number;
  listeners?: ChatMessageListener[];
  state?: 'INIT' | 'WAITING' | 'RUNNING' | 'PAUSED' | 'COMPLETED' | 'FAILED';
