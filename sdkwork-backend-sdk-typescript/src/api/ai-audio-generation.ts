...
export class AiAudioGenerationApi {
...
export function createAiAudioGenerationApi(client: HttpClient): AiAudioGenerationApi {
  return new AiAudioGenerationApi(client);
}
