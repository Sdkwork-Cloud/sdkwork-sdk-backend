...
export class AiGenerationContentApi {
...
export function createAiGenerationContentApi(client: HttpClient): AiGenerationContentApi {
  return new AiGenerationContentApi(client);
}
