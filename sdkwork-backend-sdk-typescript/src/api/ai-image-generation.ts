...
export class AiImageGenerationApi {
...
export function createAiImageGenerationApi(client: HttpClient): AiImageGenerationApi {
  return new AiImageGenerationApi(client);
}
