...
import type { PlusAiModelInfoForm, PlusApiResultBoolean, PlusApiResultListPlusAiModelInfoVO, PlusApiResultPagePlusAiModelInfoVO, PlusApiResultPlusAiModelInfoVO, QueryListForm } from '../types';


export class AiModelInformationApi {
...
/** Get AI model information by page */
  async listByPage(body?: QueryListForm, params?: QueryParams): Promise<PlusApiResultPagePlusAiModelInfoVO> {
...
/** Get all AI model information */
  async listAllEntities(body?: QueryListForm): Promise<PlusApiResultListPlusAiModelInfoVO> {
...
export function createAiModelInformationApi(client: HttpClient): AiModelInformationApi {
  return new AiModelInformationApi(client);
}
