...
/** Pin/Unpin a conversation */
  async pinConversation(id: string | number, params?: QueryParams): Promise<PlusApiResultPlusConversationVO> {
...
export function createAiConversationApi(client: HttpClient): AiConversationApi {
  return new AiConversationApi(client);
}
