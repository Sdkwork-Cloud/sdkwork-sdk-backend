...
export class AiAgentToolRelationshipApi {
...
export function createAiAgentToolRelationshipApi(client: HttpClient): AiAgentToolRelationshipApi {
  return new AiAgentToolRelationshipApi(client);
}
