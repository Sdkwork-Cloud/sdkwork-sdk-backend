...
from ..models import PlusAiModelInfoForm, PlusAiModelInfoQueryListForm, PlusApiResultBoolean, PlusApiResultListPlusAiModelInfoVO, PlusApiResultPagePlusAiModelInfoVO, PlusApiResultPlusAiModelInfoVO

class ModelInformationApi:
    """model_information API client."""
    ...
    def list_by_page(self, body: Optional[PlusAiModelInfoQueryListForm] = None, params: Optional[Dict[str, Any]] = None) -> PlusApiResultPagePlusAiModelInfoVO:
        """Get AI model information by page"""
        return self._client.post(f"/backend/v3/api/model/list", json=body, params=params)

    def list_all_entities(self, body: Optional[PlusAiModelInfoQueryListForm] = None) -> PlusApiResultListPlusAiModelInfoVO:
