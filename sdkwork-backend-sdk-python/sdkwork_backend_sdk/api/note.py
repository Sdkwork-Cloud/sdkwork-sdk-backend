...
from ..models import PlusApiResultBoolean, PlusApiResultListPlusNotesVO, PlusApiResultPagePlusMediaPublishRecordDTO, PlusApiResultPagePlusNotesVO, PlusApiResultPlusMediaPublishResultDTO, PlusApiResultPlusNotesVO, PlusNotesForm, PlusNotesMediaDraftForm, PlusNotesMediaPreviewForm, PlusNotesMediaPublishDraftForm, PlusNotesMediaPublishedArticleForm, PlusNotesMediaPublishStatusForm
...
class NoteApi:
    ...
    def query_media_publish_status(self, body: PlusNotesMediaPublishStatusForm) -> PlusApiResultPlusMediaPublishResultDTO:
        """Query publish status"""
        return self._client.post(f"/backend/v3/api/notes/media/publish/status", json=body)

    def query_published_article(self, body: PlusNotesMediaPublishedArticleForm) -> PlusApiResultPlusMediaPublishResultDTO:
        """Query published article"""
        return self._client.post(f"/backend/v3/api/notes/media/publish/article", json=body)
