---
name: sdkwork-backend-python-integration
description: Use when integrating the sdkwork-backend-sdk-python package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-backend-sdk-python` into an application using progressive stages. Advance only when the current stage exits green.
...
- Local-path integration: `pip install <path-to-sdkwork-backend-sdk-python>`
...
- `python -m pip show sdkwork-backend-sdk`
