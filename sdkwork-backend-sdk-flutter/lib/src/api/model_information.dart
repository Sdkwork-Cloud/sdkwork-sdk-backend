...
class ModelInformationApi {
  ...
  ModelInformationApi(this._client);
  ...
  Future<PlusApiResultPagePlusAiModelInfoVO?> listByPage(PlusAiModelInfoQueryListForm? body, Map<String, dynamic>? params) async {
  ...
  Future<PlusApiResultListPlusAiModelInfoVO?> listAllEntities(PlusAiModelInfoQueryListForm? body) async {
