---
name: sdkwork-backend-flutter-integration
description: Use when integrating the sdkwork-backend-sdk-flutter package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-backend-sdk-flutter` into an application using progressive stages. Advance only when the current stage exits green.
...
- SDK coordinate: `backend_sdk@1.0.0`
- Registry integration: `flutter pub add backend_sdk`
- Local-path integration: `flutter pub add backend_sdk --path <path-to-sdkwork-backend-sdk-flutter>`
