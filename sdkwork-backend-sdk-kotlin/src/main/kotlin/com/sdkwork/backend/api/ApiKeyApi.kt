...
class ApikeyApi(private val client: HttpClient) {
    ...
    suspend fun enableMyApiKey(id: String): PlusApiResultPlusApiKeyVO? {
    ...
    suspend fun disableMyApiKey(id: String): PlusApiResultPlusApiKeyVO? {
