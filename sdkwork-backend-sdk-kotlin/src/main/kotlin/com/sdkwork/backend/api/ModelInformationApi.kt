...
class ModelInformationApi(private val client: HttpClient) {
    ...
    suspend fun listByPage(body: PlusAiModelInfoQueryListForm? = null, params: Map<String, Any>? = null): PlusApiResultPagePlusAiModelInfoVO? {
    ...
    suspend fun listAllEntities(body: PlusAiModelInfoQueryListForm? = null): PlusApiResultListPlusAiModelInfoVO? {
