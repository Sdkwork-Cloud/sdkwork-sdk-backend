---
name: sdkwork-backend-kotlin-integration
description: Use when integrating the sdkwork-backend-sdk-kotlin package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-backend-sdk-kotlin` into an application using progressive stages. Advance only when the current stage exits green.
...
- Local-path integration: `implementation(files("<path-to-sdkwork-backend-sdk-kotlin/build/libs/*.jar"))`
