...
public class NoteApi {
    ...
    public PlusApiResultPlusMediaPublishResultDTO queryMediaPublishStatus(PlusNotesMediaPublishStatusForm body) throws Exception {
        return (PlusApiResultPlusMediaPublishResultDTO) client.post(ApiPaths.backendPath("/notes/media/publish/status"), body);
    }

    /** Query published article */
    public PlusApiResultPlusMediaPublishResultDTO queryPublishedArticle(PlusNotesMediaPublishedArticleForm body) throws Exception {
        return (PlusApiResultPlusMediaPublishResultDTO) client.post(ApiPaths.backendPath("/notes/media/publish/article"), body);
    }
