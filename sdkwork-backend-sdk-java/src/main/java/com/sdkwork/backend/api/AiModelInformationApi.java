...
public class AiModelInformationApi {
    ...
    public PlusApiResultPagePlusAiModelInfoVO listByPage(QueryListForm body, Map<String, Object> params) throws Exception {
    ...
    public PlusApiResultListPlusAiModelInfoVO listAllEntities(QueryListForm body) throws Exception {
