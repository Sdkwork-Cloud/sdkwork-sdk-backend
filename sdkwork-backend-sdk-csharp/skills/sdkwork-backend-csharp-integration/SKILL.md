---
name: sdkwork-backend-csharp-integration
description: Use when integrating the sdkwork-backend-sdk-csharp package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-backend-sdk-csharp` into an application using progressive stages. Advance only when the current stage exits green.
...
- Local-path integration: `dotnet add <target.csproj> reference <path-to-sdkwork-backend-sdk-csharp/Backend.csproj>`
