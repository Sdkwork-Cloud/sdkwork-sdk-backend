...
namespace Backend.Api
{
    public class NoteApi
    {
        ...
        public NoteApi(HttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<PlusApiResultPlusMediaPublishResultDTO?> QueryMediaPublishStatusAsync(PlusNotesMediaPublishStatusForm body)
        {
            return await _client.PostAsync<PlusApiResultPlusMediaPublishResultDTO>(ApiPaths.BackendPath("/notes/media/publish/status"), body);
        }

        /// <summary>
        /// Query published article
        /// </summary>
        public async Task<PlusApiResultPlusMediaPublishResultDTO?> QueryPublishedArticleAsync(PlusNotesMediaPublishedArticleForm body)
        {
            return await _client.PostAsync<PlusApiResultPlusMediaPublishResultDTO>(ApiPaths.BackendPath("/notes/media/publish/article"), body);
        }
