...
namespace Backend.Api
{
    public class AiConversationApi
    {
        ...
        public AiConversationApi(HttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<PlusApiResultPlusConversationVO?> PinConversationAsync(string id, Dictionary<string, object>? query = null)
        {
