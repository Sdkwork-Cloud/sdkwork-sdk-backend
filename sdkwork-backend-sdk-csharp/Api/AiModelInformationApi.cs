...
{
    public class AiModelInformationApi
    {
        private readonly HttpClient _client;

        public AiModelInformationApi(HttpClient client)
        {
            _client = client;
        }
        ...
        /// </summary>
        public async Task<PlusApiResultPagePlusAiModelInfoVO?> ListByPageAsync(QueryListForm? body = null, Dictionary<string, object>? query = null)
        {
        ...
        /// </summary>
        public async Task<PlusApiResultListPlusAiModelInfoVO?> ListAllEntitiesAsync(QueryListForm? body = null)
        {
