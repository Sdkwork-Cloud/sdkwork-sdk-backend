...
public class NoteApi {
    ...
    public func queryMediaPublishStatus(body: PlusNotesMediaPublishStatusForm) async throws -> PlusApiResultPlusMediaPublishResultDTO? {
        let response = try await client.post(ApiPaths.backendPath("/notes/media/publish/status"), body: body)
        return response as? PlusApiResultPlusMediaPublishResultDTO
    }

    /// Query published article
    public func queryPublishedArticle(body: PlusNotesMediaPublishedArticleForm) async throws -> PlusApiResultPlusMediaPublishResultDTO? {
        let response = try await client.post(ApiPaths.backendPath("/notes/media/publish/article"), body: body)
        return response as? PlusApiResultPlusMediaPublishResultDTO
    }
