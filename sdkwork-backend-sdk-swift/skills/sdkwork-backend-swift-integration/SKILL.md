---
name: sdkwork-backend-swift-integration
description: Use when integrating the sdkwork-backend-sdk-swift package into an application and you need staged progressive loading with explicit stage gates.
---

# Scope

Integrate `sdkwork-backend-sdk-swift` into an application using progressive stages. Advance only when the current stage exits green.
...
- SDK coordinate: `BackendSDK | https://github.com/sdkwork/backend-sdk-swift | from 1.0.0`
- Registry integration: `.package(url: "https://github.com/sdkwork/backend-sdk-swift", from: "1.0.0")`
- Local-path integration: `.package(path: "<path-to-sdkwork-backend-sdk-swift>")`
